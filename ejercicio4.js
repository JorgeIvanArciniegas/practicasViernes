...
document.getElementById("imagenes1").addEventListener("mouseenter", cambiarOpacidad1);
document.getElementById("imagen2").addEventListener("mouseenter", cambiarOpacidad2);
document.getElementById("imagen3").addEventListener("mouseenter", cambiarOpacidad3);